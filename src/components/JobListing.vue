    ...
    <div class="p-4">
      ...
      <div class="flex flex-col lg:flex-row justify-between mb-4">
        ...
        <RouterLink :to="'/jobs/' + job.id"
          class="h-[36px] bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-center text-sm leading-3">
          Read More
        </RouterLink>
      </div>
    </div>
